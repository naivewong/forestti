...
class RefSeries {
 public:
  ...
  ::tsdb::label::Labels* lset_ptr;
  int64_t flushed_txn;
  int64_t log_clean_txn;

  RefSeries() : lset_ptr(nullptr), flushed_txn(0), log_clean_txn(0) {}
  RefSeries(uint64_t ref, const ::tsdb::label::Labels& lset)
      : ref(ref),
        ...
        flushed_txn(0),
        log_clean_txn(0) {}
  RefSeries(uint64_t ref, ::tsdb::label::Labels* lset)
      : ref(ref), lset_ptr(lset), flushed_txn(0), log_clean_txn(0) {}
};
...
class RefFlush {
 public:
  ...
  RefFlush() = default;
  RefFlush(uint64_t ref, uint64_t logical_id, int64_t txn)
      : ref(ref), logical_id(logical_id), txn(txn) {}
};
