...
class EmptySeriesIterator : public SeriesIteratorInterface {
 public:
  virtual bool seek(int64_t t) const override { return false; }
  virtual std::pair<int64_t, double> at() const override { return {0, 0.0}; }
  virtual bool next() const override { return false; }
